...
target("lab4")
    ...
    -- Keep only Motion Matching for Lab 4.
    remove_files   ("src/VCX/Labs/4-Animation/CaseInverseKinematics.cpp")
    remove_files   ("src/VCX/Labs/4-Animation/IKSystem.cpp")
    remove_files   ("src/VCX/Labs/4-Animation/CaseMassSpring.cpp")
    remove_files   ("src/VCX/Labs/4-Animation/tasks.cpp")